...
public interface FoxAccessor {
    ...
    static EntityDataAccessor<Optional<EntityReference<LivingEntity>>> nixreaper$trusted0() {
        throw new AssertionError("mixin accessor not applied");
    }

    @Accessor("DATA_TRUSTED_ID_1")
    static EntityDataAccessor<Optional<EntityReference<LivingEntity>>> nixreaper$trusted1() {
        throw new AssertionError("mixin accessor not applied");
    }
}
